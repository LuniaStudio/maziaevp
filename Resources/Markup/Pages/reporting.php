<!doctype html>
<html lang="en">
<title>Mazia EVP | Reporting</title>
<base href="<?= URL ?>">
...
<meta name="description" content="Detailed reports at your fingertips">
...
<meta property="og:title" content="Mazia EVP | Reporting">
<meta property="og:description" content="Detailed reports at your fingertips">
<meta property="og:locale" content="en_ZA">
<meta property="og:url" content="https://www.maziaevp.com/reporting">
...
<header data-util="row(cc)s bgd(gry)s">
    ...
    <layout-wrapper data-util="row(jc)s wid(max)s pad.x(2,0)s">
        ...
        <nav class="menu-container" data-util="col(ct)s row(rc)l gap(2,0)s wid(max)s pad.l(4,0)s- pad.l(4,0)m- pad.t(8,0)s- pad.t(8,0)m- pad.b(4,0)s- pad.b(4,0)m-">
            ...
            <a class="menu-item" data-util="col(lc)s wid(max)s- wid(max)m- txt(3)s txt(2)l txt(bld)s txt(wht)s txt(red.2)l txt(red.1)h" href="reporting" title="Reporting" aria-label="Reporting" tabindex="0">Reporting</a>
...
<main>
        ...
        <layout-wrapper data-util="col(lc)s">
            ...
            <content-wrapper data-util="col(cc)s row(lc)l gap(1,0)m pad.x(2,0)s">
                ...
                <section class="hero-copy" data-util="col(lt)s gap(1,5)s pad.y(4,0)s">
                    ...
                    <h1 data-util="fnt(ttl)s txt(5)s txt(8)m txt(blk.2)s">Detailed reports at your fingertips</h1>

                    <!-- Hero summary -->

                    <p data-util="txt(3)s txt(blk.2)s">Transform your organisation's data into insights that inform decision-making and empower you to respond to opportunities <no-break>and challenges</no-break>.</p>

                    <!-- Hero call to action -->

                    <a class="primary" data-util="wid(min)s" href="reporting#contact" data-role="button" title="Let's Start" aria-label="Let's Start" tabindex="0">Let's Start</a>
                ...
                <aside class="image-wrapper" data-util="dis(off)s- dis(off)m-">
                    ...
                    <image-container data-photo="reporting-2" role="img" aria-label="Women planning at a desk"></image-container>
    ...
    <article data-util="bgd(wht)s" id="partnerships">
        ...
        <layout-wrapper data-util="col(cc)s">
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.y(4,0)s pad.x(2,0)s">
                ...
                <section class="wrap" data-util="row(cc)s gap(1,5)s">
                    ...
                    <h2 data-util="wid(max)s wid(70)m fnt(ttl)s txt(c)s txt(5)s txt(7)m txt(blk.2)s">Stay informed with <no-break>real-time</no-break> information</h2>

                    <!-- Partnerships summary -->

                    <p data-util="wid(max)s wid(90)m txt(3)s txt(c)s txt(blk.2)s">Effective, real-time reporting is essential in keeping an organisation aligned. Well-structured reports help foster transparency and accountability, creating trust among stakeholders and helping you meet your objectives <no-break>more efficiently</no-break>.</p>
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.y(4,0)s pad.x(2,0)s">
                ...
                <section data-util="col(cc)s gap(2,0)s">
                    ...
                    <content-wrapper data-util="col(cc)s row(str)m wid(max)s gap(2,0)s">
                        ...
                        <!-- Informed Decisions tile -->

                        <layout-tile data-util="col(ct)s gap(1,5)s wid(max)s pad(2,0)s rad(2)s bgd(wht)s">

                            <!-- Informed Decisions icon -->

                            <image-container data-icon="info"></image-container>

                            <!-- Informed Decisions heading -->

                            <h3 data-util="wid(max)s fnt(ttl)s txt(4)s txt(c)s txt(blk.2)s">Informed Decisions</h3>

                            <!-- Informed Decisions summary -->

                            <p data-util="wid(max)s txt(3)s txt(c)s txt(blk.2)s">Make better and faster decisions with real-time access to relevant data from across <no-break>your organisation</no-break>.</p>
                        ...
                        <layout-tile data-util="col(ct)s gap(1,5)s wid(max)s pad(2,0)s rad(2)s bgd(wht)s">
                            ...
                            <image-container data-icon="shield"></image-container>

                            <!-- X and Speed heading -->

                            <h3 data-util="wid(max)s fnt(ttl)s txt(4)s txt(c)s txt(blk.2)s">Risk Management</h3>

                            <!-- X and Speed summary -->

                            <p data-util="wid(max)s txt(3)s txt(c)s txt(blk.2)s">Pattern analysis helps you identify security risks and ensure industry compliance so proactive measures can be taken <no-break>when needed</no-break>.</p>
                    ...
                    <content-wrapper data-util="col(cc)s row(str)m wid(max)s gap(2,0)s">
                        ...
                        <layout-tile data-util="col(ct)s gap(1,5)s wid(max)s pad(2,0)s rad(2)s bgd(wht)s">
                            ...
                            <image-container data-icon="calendar-clock"></image-container>

                            <!-- X and Speed heading -->

                            <h3 data-util="wid(max)s fnt(ttl)s txt(4)s txt(c)s txt(blk.2)s">Project Tracking</h3>

                            <!-- X and Speed summary -->

                            <p data-util="wid(max)s txt(3)s txt(c)s txt(blk.2)s">Maintain a clear view of progress, milestones, and resource allocation so projects stay on track and stakeholders <no-break>are kept informed</no-break>.</p>

                        </layout-tile>

                        <!-- Organisational Insights and Speed tile -->

                        <layout-tile data-util="col(ct)s gap(1,5)s wid(max)s pad(2,0)s rad(2)s bgd(wht)s">

                            <!-- Organisational Insights icon -->

                            <image-container data-icon="document-view"></image-container>

                            <!-- Organisational Insights heading -->

                            <h3 data-util="wid(max)s fnt(ttl)s txt(4)s txt(c)s txt(blk.2)s">Organisational Insights</h3>

                            <!-- Organisational Insights summary -->

                            <p data-util="wid(max)s txt(3)s txt(c)s txt(blk.2)s">Gain deeper insights into performance, trends, and customer behaviour by analysing <no-break>consolidated information</no-break>.</p>
        ...
        <layout-wrapper data-util="col(cc)s">
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.x(2,0)s pad.y(4,0)s">
                ...
                <section data-util="col(cc)s gap(2,0)s wid(max)s">
                    ...
                    <h3 data-util="wid(max)s wid(80)m fnt(ttl)s txt(c)s txt(5)s txt(7)m txt(blk.2)s">Let's talk about how you can access detailed reports</h3>
                ...
                <section data-util="row(cc)s gap(1,0)s wid(max)s">
                    ...
                    <form data-util="col(lc)s gap(2,0)s wid(max)s wid(500)m pad(2,0)s rad(2)s shd(1)s bgd(wht)s" action="https://usebasin.com/f/09e47d7025be" method="POST" accept-charset="utf-8">
                        ...
                        <input-group data-util="dis(off)s">
                            ...
                            <input name="service" id="service" type="text" maxlength="1" title="Service" value="Reporting" tabindex="0" aria-label="Service">
