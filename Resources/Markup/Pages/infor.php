...
<meta charset="utf-8">
<meta name="pagename" content="Infor">
<meta name="description" content="Complete industry suites built in the cloud">
<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">

<!-- Canonical URL -->

<link href="https://www.maziaevp.com/apps/infor" rel="canonical">

<!-- Open graph -->

<meta property="og:site_name" content="Mazia EVP">
<meta property="og:title" content="Mazia EVP | Infor">
<meta property="og:description" content="">
<meta property="og:locale" content="en_ZA">
<meta property="og:url" content="https://www.maziaevp.com/apps/infor">
...
<!--                 <span class="dropdown-menu">
            ...
            <a class="menu-item" data-util="col(lc)s wid(max)s- wid(max)m- txt(3)s txt(2)l txt(bld)s txt(wht)s txt(blk.2)l txt(red.1)h" href="apps/infor#contact" title="Contact" aria-label="Contact" tabindex="0">Contact</a>
...
<main>
    ...
    <article data-util="bgd(gry)s" id="partnerships">
        ...
        <layout-wrapper data-util="col(cc)s">
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.y(4,0)s pad.x(2,0)s">
                ...
                <section class="wrap" data-util="col(cc)s gap(1,5)s">

                    <!-- Logo -->

                    <a href="https://infor.com/" target="_blank" rel="noopener" title="Infor" aria-label="Infor" tabindex="0">

                        <image-container data-logo="infor" data-logo-size="big" role="img" aria-label="Infor"></image-container>

                    </a>

                    <!-- Main heading -->

                    <h2 data-util="wid(max)s wid(70)m fnt(ttl)s txt(c)s txt(5)s txt(7)m txt(blk.2)s">Complete industry suites built in the cloud</h2>

                    <!-- Main summary -->

                    <p data-util="wid(max)s wid(70)m txt(c)s txt(3)s txt(blk.2)s">Infor is a global leader in business cloud software products for companies in industry-specific markets. Infor builds complete industry suites in the cloud and efficiently deploys technology that puts the user experience first, leverages data science, and integrates easily into <no-break>existing systems</no-break>.</p>

                    <!-- Content wrapper -->

                    <content-wrapper data-util="row(cc)s gap(1,0)s">

                        <!-- Calls to action -->

                        <a class="primary" data-util="wid(min)s" href="https://www.infor.com/customer-stories" target="_blank" rel="noopener" data-role="button" title="Case Studies" aria-label="Case Studies" tabindex="0">Case Studies</a>

                        <a class="secondary" data-util="wid(min)s" href="https://infor.maziaevp.com/" data-role="button" title="Demo" aria-label="Demo" tabindex="0">Demo</a>
    ...
    <article data-util="bgd(blk)s" id="contact">
        ...
        <layout-wrapper data-util="col(cc)s">
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.x(2,0)s pad.y(4,0)s">
                ...
                <section data-util="col(cc)s gap(2,0)s wid(max)s">
                    ...
                    <h3 data-util="wid(max)s wid(80)m fnt(ttl)s txt(c)s txt(5)s txt(7)m txt(wht)s">Let's talk about how Infor can improve your organisation</h3>
                ...
                <section data-util="row(cc)s gap(1,0)s wid(max)s">
                    ...
                    <form data-util="col(lc)s gap(2,0)s wid(max)s wid(500)m pad(2,0)s rad(2)s shd(1)s bgd(wht)s" action="https://usebasin.com/f/09e47d7025be" method="POST" accept-charset="utf-8">
                        ...
                        <input-group data-util="dis(off)s">
                            ...
                            <input name="service" id="service" type="text" maxlength="1" title="Service" value="Infor" tabindex="0" aria-label="Infor">
    ...
    <footer data-util="bgd(blk.2)s">
        ...
        <layout-wrapper data-util="col(lc)s">
            ...
            <content-wrapper data-util="col(lc)s gap(3,0)s pad.x(2,0)s pad.y(4,0)s">
                ...
                <section data-util="col(lt)s gap(0,5)s">
