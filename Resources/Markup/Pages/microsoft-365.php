...
<meta charset="utf-8">
<meta name="pagename" content="Microsoft 365">
<meta name="description" content="Create, share, and collaborate with Microsoft">
<meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover">

<!-- Canonical URL -->

<link href="https://www.maziaevp.com/apps/microsoft-365" rel="canonical">

<!-- Open graph -->

<meta property="og:site_name" content="Mazia EVP">
<meta property="og:title" content="Mazia EVP | Microsoft 365">
<meta property="og:description" content="">
<meta property="og:locale" content="en_ZA">
<meta property="og:url" content="https://www.maziaevp.com/apps/microsoft-365">
...
<!--                 <span class="dropdown-menu">
            ...
            <a class="menu-item" data-util="col(lc)s wid(max)s- wid(max)m- txt(3)s txt(2)l txt(bld)s txt(wht)s txt(blk.2)l txt(red.1)h" href="apps/microsoft-365#contact" title="Contact" aria-label="Contact" tabindex="0">Contact</a>
        ...
        <layout-wrapper data-util="col(cc)s">
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.y(4,0)s pad.x(2,0)s">
                ...
                <section class="wrap" data-util="col(cc)s gap(1,5)s">
                    ...
                    <a href="https://microsoft365.com/" target="_blank" rel="noopener" title="Microsoft 365" aria-label="Microsoft 365" tabindex="0">

                        <image-container data-logo="microsoft-365" data-logo-size="big" role="img" aria-label="Microsoft 365"></image-container>

                    </a>

                    <!-- Main heading -->

                    <h2 data-util="wid(max)s wid(70)m fnt(ttl)s txt(c)s txt(5)s txt(7)m txt(blk.2)s">Create, share, and collaborate with Microsoft</h2>

                    <!-- Main summary -->

                    <p data-util="wid(max)s wid(70)m txt(c)s txt(3)s txt(blk.2)s">The best tools. Your best team. The world at your fingertips. Microsoft 365 empowers your employees to do their best work from anywhere in the world, together in <no-break>one place</no-break>.</p>
                    ...
                    <content-wrapper data-util="row(cc)s gap(1,0)s">
                        ...
                        <a class="primary" data-util="wid(min)s" href="https://adoption.microsoft.com/en-us/case-studies/" target="_blank" rel="noopener" data-role="button" title="Case Studies" aria-label="Case Studies" tabindex="0">Case Studies</a>

                        <a class="secondary" data-util="wid(min)s" href="" data-role="button" title="Demo" aria-label="Demo" tabindex="0">Demo</a>
        ...
        <layout-wrapper data-util="col(cc)s">
            ...
            <content-wrapper data-util="col(cc)s gap(3,0)s pad.x(2,0)s pad.y(4,0)s">
                ...
                <section data-util="col(cc)s gap(2,0)s wid(max)s">
                    ...
                    <h3 data-util="wid(max)s wid(80)m fnt(ttl)s txt(c)s txt(5)s txt(7)m txt(wht)s">Let's talk about how <no-break>Microsoft 365</no-break> can improve your organisation</h3>
                ...
                <section data-util="row(cc)s gap(1,0)s wid(max)s">
                    ...
                    <form data-util="col(lc)s gap(2,0)s wid(max)s wid(500)m pad(2,0)s rad(2)s shd(1)s bgd(wht)s" action="https://usebasin.com/f/09e47d7025be" method="POST" accept-charset="utf-8">
                        ...
                        <input-group data-util="dis(off)s">
                            ...
                            <input name="service" id="service" type="text" maxlength="1" title="Service" value="Microsoft 365" tabindex="0" aria-label="Microsoft 365">
